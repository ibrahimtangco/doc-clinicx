									...
									@foreach ($prescriptions as $prescription)
										<tr class="bg-white border-b hover:bg-gray-50">
											...
											<td class="px-6 py-4 text-right gap-2 flex items-center">
												<a class="font-medium text-white bg-green-600 px-2 py-1 rounded hover:bg-green-700 flex items-center justify-center gap-1 w-fit" href="{{ route('admin.prescriptions.downloadPDF', ['prescription' => $prescription->id]) }}">
													<svg fill="currentColor" height="19" viewBox="0 0 512 512" width="19" xmlns="http://www.w3.org/2000/svg">
														<title />
														<g data-name="1" id="_1">
												...
												<a class="font-medium text-white bg-blue-600 px-2 py-1 rounded hover:bg-blue-700 flex items-center justify-center gap-1 w-fit" href="{{ route('admin.prescriptions.previewPDF', ['prescription' => $prescription->id]) }}">
