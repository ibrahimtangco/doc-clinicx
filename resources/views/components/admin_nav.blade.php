	...
	<div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
		<div class="flex items-center lg:hidden">
			...
			<button @click.stop="isAsideOpen = !isAsideOpen"
				class="z-20 block rounded-sm border border-gray-300 bg-white p-1.5 shadow-sm">
                <img x-bind:src="!isAsideOpen ? '{{ asset('images/icons/menu.svg') }}' : '{{ asset('images/icons/close_dark.svg') }}'" alt="">
			</button>
			<!-- Hamburger Toggle BTN -->
            <img src="{{ asset('images/LOGO_ICON.png') }}" alt="" class="w-16">
		</div>
		<div>
